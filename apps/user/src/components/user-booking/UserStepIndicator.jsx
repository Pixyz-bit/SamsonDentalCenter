...
/**
 * User-specialized StepIndicator:
 * - Syncs with Guest Booking aesthetics (brand-500, premium shadows)
 * - Tailored for the 4-step authenticated flow
 */
const UserStepIndicator = ({ currentStep, onStepClick, labels, isLocked = false }) => {
    const defaultLabels = ['Service', 'Schedule', 'Details', 'Review'];
...
export default UserStepIndicator;
