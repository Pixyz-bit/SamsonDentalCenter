                ...
                <div className='flex flex-1 sm:flex-none gap-3 sm:justify-end w-full'>
                    ...
                    {isReschedulable && (
                        <button
                            ...
                            className={`flex-1 sm:flex-none sm:min-w-[160px] inline-flex items-center justify-center gap-2 px-4 py-2.5 sm:py-3 text-[11px] sm:text-[15px] font-bold rounded-lg transition-[background-color,box-shadow] ${
                                hasRescheduled
