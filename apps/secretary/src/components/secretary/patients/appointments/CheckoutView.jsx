        ...
        <div className="flex flex-col h-full overflow-hidden animate-in fade-in slide-in-from-right-4 duration-500">
            ...
            <div className="px-4 sm:px-6 py-4 border-b border-gray-100 dark:border-gray-800 flex items-center justify-between sticky top-0 bg-white/95 dark:bg-gray-900/95 backdrop-blur-sm z-30 shrink-0">
                ...
                <div className="flex flex-col items-center text-center">
                    <h2 className="text-xl font-bold text-gray-900 dark:text-white font-outfit tracking-tight leading-tight">Finalize Check Out</h2>
                    <p className="text-[10px] sm:text-xs text-gray-500 dark:text-gray-400 font-medium mt-0.5">Review treatment details and patient information.</p>
                </div>
            ...
            <div className="grow overflow-y-auto no-scrollbar">
                <div className="p-4 sm:p-6 lg:p-8 space-y-6 max-w-[640px] mx-auto">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 pt-4 pb-12">
                        ...
                        <button 
                            onClick={onConfirm}
                            className="inline-flex items-center justify-center gap-2 rounded-xl transition flex-1 h-12 font-black text-[11px] uppercase tracking-widest bg-brand-500 text-white shadow-xl shadow-brand-500/20 hover:bg-brand-600 active:scale-95"
                        >
