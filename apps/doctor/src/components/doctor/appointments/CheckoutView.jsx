        ...
        <div className="flex flex-col h-full overflow-hidden animate-in fade-in slide-in-from-right-4 duration-500">
            ...
            <div className="px-4 sm:px-6 py-4 border-b border-gray-100 dark:border-gray-800 flex items-center justify-between sticky top-0 bg-white/95 dark:bg-gray-900/95 backdrop-blur-sm z-30 shrink-0">
                ...
                <div className="flex flex-col items-center text-center">
                    <h2 className="text-xl font-bold text-gray-900 dark:text-white font-outfit tracking-tight leading-tight uppercase">Finalize Clinical Invoice</h2>
                    <p className="text-[10px] sm:text-xs text-gray-500 dark:text-gray-400 font-medium mt-0.5">Review treatment details and patient clinical record.</p>
                </div>
            ...
            <div className="grow overflow-y-auto no-scrollbar">
                <div className="p-4 sm:p-6 lg:p-8 space-y-6 max-w-[640px] mx-auto">
                    ...
                    <div className="rounded-2xl border border-gray-100 dark:border-white/5 bg-gray-50/30 dark:bg-white/[0.01] overflow-hidden shadow-sm">
                        <div className="p-5 flex items-start justify-between gap-4 border-b border-gray-50 dark:border-white/5">
                            ...
                            <div className="text-right shrink-0">
                                ...
                                <p className="text-sm font-bold text-gray-900 dark:text-white font-outfit uppercase">{appointment.doctor}</p>
                            </div>
                        </div>
                        ...
                        <div className="p-4 bg-brand-50/20 dark:bg-brand-500/[0.02] border-t border-gray-50 dark:border-white/5 flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-[10px] font-black uppercase px-2 py-0.5 rounded-full bg-amber-100 text-amber-700 dark:bg-amber-900/30">In Progress</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 pt-4 pb-12">
                        <button 
                            onClick={onBack}
                            className="inline-flex items-center justify-center gap-2 rounded-xl transition flex-1 h-12 font-black text-[11px] uppercase tracking-widest border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-white/[0.03] shadow-theme-xs active:scale-95"
                        >
                            Cancel
                        </button>
                        <button 
                            onClick={onConfirm}
                            className="inline-flex items-center justify-center gap-2 rounded-xl transition flex-1 h-12 font-black text-[11px] uppercase tracking-widest bg-amber-500 text-white shadow-xl shadow-amber-500/20 hover:bg-amber-600 active:scale-95"
                        >
